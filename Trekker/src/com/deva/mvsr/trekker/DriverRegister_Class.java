...
public class DriverRegister_Class {
	AmazonSimpleDBClient sdbClient;
	String nextToken;
	protected int count;
	private static final String REG_DOMAIN = "TrackBusReg";

	public DriverRegister_Class() {
	...
	public int loginVerify(String usern, String passw) {
		...
		SelectRequest selectRequest = new SelectRequest(
				"select * from TrackBusReg where PHONE_NO='" + usern
						+ "' and PASSWORD='" + passw + "'")
