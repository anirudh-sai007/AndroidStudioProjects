...
public class StudentRegister_Class {

	AmazonSimpleDBClient sdbClient;
	String nextToken;
	protected int count;
	private static final String REG_DOMAIN = "TrackBusUserReg";

	public StudentRegister_Class() {
	...
	public int loginVerify(String usern, String passw) {
		...
		SelectRequest selectRequest = new SelectRequest(
				"select * from TrackBusUserReg where PHONE_NO='" + usern
						+ "' and PASSWORD='" + passw + "'")
